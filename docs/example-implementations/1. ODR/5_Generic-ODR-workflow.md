...
### Figma 
![discovery](./media/figma-discovery.png)
...
### Figma 
![ordering](./media/figma-ordering.png)<br/>
![ordering](./media/figma-ordering2.png)<br/>
![ordering](./media/figma-ordering3.png)<br/>
...
![fulfilment](./media/fulfilment.png) <br/>
![fulfilment](./media/figma-fulfilment.png) <br/>
...
#### Beckn API Logical Worklow
![post-fulfilment](./media/post_fulfilment.png)<br/>
![post-fulfilment](./media/figma-post_fulfilment.png)<br/>
